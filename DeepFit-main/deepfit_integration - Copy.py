...
def run_full_workout_motion(count, direction, form, elbow_angle, shoulder_angle, hip_angle, elbow_angle_right, shoulder_angle_right, hip_angle_right, knee_angle, success_percentage, feedback, workout_name_after_smoothening):
    workout_name = workout_name_after_smoothening.strip()
    ...
    elif workout_name == "situps":
        if form == 1:
            if success_percentage == 0:
                if hip_angle <= 45 and knee_angle > 90:
                    feedback = "Feedback: Go Up"
                    if direction == 0:
                        count += 0.5
                        direction = 1
                    ...
                    feedback = "Feedback: Bad Form."
            if success_percentage == 100:
                if hip_angle > 160 and knee_angle > 90:
                    feedback = "Feedback: Go Down"
                    if direction == 1:
                        count += 0.5
                        direction = 0
    ...
    elif workout_name == "tricep_extensions":
        if form == 1:
            if success_percentage == 0:
                if elbow_angle <= 90:
                    feedback = "Feedback: Straighten Arms"
                    if direction == 0:
                        count += 0.5
                        direction = 1
                else:
            ...
            if success_percentage == 100:
                if elbow_angle > 160:
                    feedback = "Feedback: Lower Dumbbells"
                    if direction == 1:
                        count += 0.5
                        direction = 0
                else:
    ...
    elif workout_name == "dumbbell_rows":
        if form == 1:
            if success_percentage == 0:
                if shoulder_angle <= 45 and elbow_angle <= 90:
                    feedback = "Feedback: Pull Dumbbells Up"
                    if direction == 0:
                        count += 0.5
                        direction = 1
                else:
                    feedback = "Feedback: Bad Form."
            if success_percentage == 100:
                if shoulder_angle > 90 and elbow_angle > 160:
                    feedback = "Feedback: Lower Dumbbells"
                    if direction == 1:
                        count += 0.5
                        direction = 0
    ...
    elif workout_name == "jumping_jacks":
        if form == 1:
            if success_percentage == 0:
                if shoulder_angle <= 90 and hip_angle > 160:
                    feedback = "Feedback: Jump and Extend Arms"
                    if direction == 0:
                        count += 0.5
                        direction = 1
                else:
            ...
            if success_percentage == 100:
                if shoulder_angle > 90 and hip_angle < 160:
                    feedback = "Feedback: Land and Lower Arms"
                    if direction == 1:
                        count += 0.5
                        direction = 0
                else:
    ...
    elif workout_name == "dumbbell_shoulder_press":
        if form == 1:
            if success_percentage == 0:
                if elbow_angle <= 90:
                    feedback = "Feedback: Press Dumbbells Up"
                    if direction == 0:
                        count += 0.5
                        direction = 1
                else:
    ...
    elif workout_name == "lateral_shoulder_raises":
        if form == 1:
            if success_percentage == 0:
                if shoulder_angle <= 90:
                    feedback = "Feedback: Raise Arms to Side"
                    if direction == 0:
                        count += 0.5
                        direction = 1
                else:
    ...
    return count, direction, feedback
...
def main():
    ...
    while cap.isOpened():
        ...
        if len(landmark_list) != 0:
            ...
            #Full workout motiondef run_full_workout_motion(count, direction, form, elbow_angle, shoulder_angle, hip_angle, elbow_angle_right, shoulder_angle_right, hip_angle_right, knee_angle, success_percentage, feedback, workout_name_after_smoothening):
            workout_name = workout_name_after_smoothening.strip()
        ...
        display_workout_stats(count, form, feedback, draw_percentage_progress_bar, display_rep_count, show_workout_feedback, show_workout_name_from_model, img, success_percentage, progress_bar, workout_name_after_smoothening)
